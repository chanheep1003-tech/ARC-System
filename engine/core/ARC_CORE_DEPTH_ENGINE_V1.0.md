...
## 1. DEPTH PRIORITY — INTERNAL ONLY
...
## 3. HIGH_DIFFICULTY DEPTH STACK
HIGH_DIFFICULTY concept는 범위 안에서 필요한 항목을 선택적으로 확장한다.
...
END ARC CORE DEPTH ENGINE V1.0
