# ARC CORE CONTENT ENGINE V1.2
DATE: 2026-09-19
STATUS: ACTIVE-DEV
ROLE: 상세 내신 개념서 콘텐츠 생성
BASE_RULESET: ARC 1.7.4-dev
...
DEPTH_PRIORITY:
- 학생용 표시 금지
- engine/core/ARC_CORE_DEPTH_ENGINE_V1.0.md로 결정
...
engine/core/ARC_CORE_DEPTH_ENGINE_V1.0.md를 적용해 STANDARD / ADVANCED / HIGH_DIFFICULTY를 내부 분류한다.
...
END ARC CORE CONTENT ENGINE V1.2
