...
7. `quality/ARC_SOURCE_LEDGER_V1.0.md`
...
## SOURCE LINK
핵심 사실·학교자료·외부자료에 의존하면 SOURCE_REQUIRED=true로 표시하고 SOURCE_ID를 연결한다.
생성 단계에서 출처를 VERIFIED로 가정하지 않는다. PASS B 재열람 전 상태는 UNVERIFIED다.
