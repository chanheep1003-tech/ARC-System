...
V1.3는 자동 점수 인플레이션과 '형식상 PASS'를 차단하고, frozen regression fixture로 규칙 변경의 회귀를 검출한다.
...
ARC_ITEM_QUALITY_RUBRIC_V1.2의 ZERO-REJECTION / PREMIUM-RATE AUDIT를 실행한다.
