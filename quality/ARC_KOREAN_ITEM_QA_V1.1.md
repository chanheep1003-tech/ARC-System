...
## 4-A. QUESTION TASK-FORM GATE
지문군 10문항:
- SINGLE_BEST_STATEMENT <= 4
- EXCEPT_INCORRECT <= 2
- QUESTION_TASK_FORM 종류 >= 4
- 동일 task form 3연속 금지
- CASE_APPLICATION >= 2
- 단순 SINGLE_BEST + EXCEPT만으로 7문항 이상 구성되면 FAIL

다양성은 발문 표현이 아니라 실제 판단 과업으로 측정한다.

KOR_TASK_FORM_DIVERSITY:
PASS / REVISE / FAIL
