# ARC_VISUAL_AUTHENTICITY_RUBRIC_V1.1
VERSION: 1.1
DATE: 2026-09-18
STATUS: ACTIVE
...
AI 장식성뿐 아니라 self-check only 구조를 제거한다.
필수 TRUE_VISUAL은 deterministic renderer와 ARC_VISUAL_PASS_AB_V1.0의 독립 재검증을 거친다.
...
- 자료가 정답을 노골적으로 암시
- ESSENTIAL visual인데 VISUAL_PASS_A 또는 VISUAL_PASS_B 미실행/FAIL
- QUESTION_VISUAL_CROSSCHECK FAIL
- SCI-PARTICLE가 REDOX_LEDGER와 입자 수/전하/이온 수에서 불일치
...
## SOCIAL
- SOC_VISUAL_SPEC_V1.0 적용
- 지도 verified base / 구역·경계·범례
- 통계 metric·단위·분모·기준연도·범주
- 인구피라미드 좌우/연령대
- 흐름도 node/edge/방향
- 기관도 actor/action/institution/power/remedy 관계
- compare 자료 동일 기준 유지
- 마케팅 인포그래픽 스타일 금지
...
RENDERER
RENDER_MANIFEST_ID
VISUAL_RUBRIC_VERSION=ARC-VAR-V1.1
