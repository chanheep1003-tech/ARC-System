...
- QA_BENCH_VERSION = 1.2 이상
- SCORE_CEILINGS_APPLIED 기록 존재
- QUALITY_COMPONENTS에 항목별 숫자+근거 존재
- SENTINEL_RECHECK PASS
- QA_STATUS = PASS
- SOURCE_REQUIRED이면 ANSWER_BASIS SOURCE 모두 VERIFIED
- ESSENTIAL visual이면 VISUAL_PASS_A/B + QUESTION_VISUAL_CROSSCHECK PASS
- quantitative similarity가 CALIBRATED 환경에서 CRITICAL 아님
...
- USE_COUNT_FINAL
- LAST_USED_DATE
- SOURCE_REQUIRED / SOURCE_IDS / SOURCE_STATUS_SUMMARY
- VISUAL_PASS_A / VISUAL_PASS_B / QUESTION_VISUAL_CROSSCHECK
- SIMILARITY_RISK / THRESHOLD_STATUS / NEAREST_BANK_ITEM
